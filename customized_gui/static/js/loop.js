    ...
    if(victims_info.length > 1 && victims_info.length != victim_num_last_tick){
        ...
        post_mhc_message("post_explanations", JSON.stringify(victims_data), function(result){
            ...
            if(result['value1'] != null){
                statement.innerHTML += 
                `<div>
                However, if you would have swapped <img src="/fetch_external_media/${result['value1']}.svg" width="25" height="25"></img> and <img src="/fetch_external_media/${result['value2']}.svg" width="25" height="25"></img>, 
